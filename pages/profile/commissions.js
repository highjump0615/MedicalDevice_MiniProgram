  ...
  getList: function (isRefresh) {
    ...
    api.postRequest(paramData, 
      function success(res) {
        ...
        // 更新数据
        that.setData({
          lastValue: res.data.lastcommission,
          currrentValue: res.data.currentcommission,
          remainValue: res.data.commissionbalance,
          availableValue: res.data.canwithdrawcommission,
          items: records
        });
      },
      function fail(err) {
